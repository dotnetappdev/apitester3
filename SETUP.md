# VeriAPI - Development Setup Guide

## Overview

VeriAPI is a professional desktop API testing tool built with Electron, React, and TypeScript. This guide will help you set up the development environment and get the application running.
...
2. Find the Windows executable: `VeriAPI.exe` or `apitester3.exe`
