# Installer Setup for API Tester 3

This document describes how to build and distribute installers for API Tester 3 across Windows, macOS, and Linux platforms.

## Overview

API Tester 3 uses **electron-builder** as the primary packaging tool with platform-specific enhancements:
...
- **Output**: `API Tester 3-{version}.dmg`
- **Features**:
...
#### AppImage (Universal)
- **Output**: `API Tester 3-{version}.AppImage`
- **Features**: 
